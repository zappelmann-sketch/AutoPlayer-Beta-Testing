...
![Features](https://img.shields.io/badge/Features-113-yellow?style=for-the-badge)
...
| **Lines of Code** | 19.616 |
| **Features** | 113 (F-001 – F-133) |
| **UI-Screens** | 62 |
...
AutoPlayer entstand aus einem echten Bedarf: Ein modernes Fahrzeug mit 10,1"-Android-Auto-Display, aber kein Player am Markt der sowohl vollständige Offline-Bibliothek als auch intelligente Funktionen und erstklassige Auto-Integration bietet. Was als persönliches Projekt begann, entwickelte sich in ~8 Wochen zu einer App mit 113 Features, 62 UI-Screens und 26 Sprachen – entwickelt mit Unterstützung von Claude AI als Entwicklungspartner.
...
║  │  │ 62 Screens│  │25 VMs    │  │  Drawer + NavHost  │    │    ║
║  │  └──────────┘  └──────────┘  └────────────────────┘    │    ║
║  └─────────────────────────────────────────────────────────┘    ║
║                              │                                   ║
║  ┌─────────────────────────────────────────────────────────┐    ║
...
║  │  │ 1.551 LOC   │  │MediaBrowser  │  │  Party Mode  │  │    ║
║  │  │ MediaLibrary │  │ AutoMediaBr. │  │  Nearby API  │  │    ║
║  │  └──────────────┘  └──────────────┘  └──────────────┘  │    ║
║  └─────────────────────────────────────────────────────────┘    ║
║                                                                  ║
╚══════════════════════════════════════════════════════════════════╝
...
│   └── repository/       8 Repositories (MusicRepo, PetRepo, etc.)
│
├── 📦 domain/
│   ├── model/            7 Domain-Modelle (Song, Album, Artist, Pet...)
│   └── usecase/          Business-Logik Use Cases
│
├── 📦 player/ (149 Module)
│   ├── gesture/          Gestensteuerung
│   ├── sound/voices/     Voice-TTS Engine
│   └── synth/            Synthesizer-Engine (FM, Wavetable, Subtractive)
│
├── 📦 presentation/
│   ├── components/       58+ wiederverwendbare Compose-Komponenten
│   ├── navigation/       Navigation + Drawer
│   ├── screens/          62 Feature-Screens
│   ├── theme/            12 Farbthemes
...
April 2026
  ...
  ├─ 22.04  ✅ v4.3: Loop Mixer + Pad Mode
...
- DSP-basiert, funktioniert vollständig offline
...
| **Weather DJ** | Wetter-API → passende Musik |
| **Heartbeat Sync** | Health Connect → BPM-angepasste Wiedergabe |
| **Kontext Auto-Wechsel** | 12+ Bedingungen (Bewegung, Tageszeit, Kalender) |
...
```
LOOP MIXER ──────────────────────────────────────────────────
│  8 Spuren · 4 Effekte · BPM-Sync · Swing · Bounce to WAV
│  Templates · Marker · Projekt-Sharing
│
SYNTHESIZER STUDIO ──────────────────────────────────────────
│  Subtractive Synth  │  300+ Factory Presets
│  FM DX7-Style       │  200 Presets, 4 Operatoren, 8 Alg.
│  Wavetable          │  8 Tables, Position Modulation
│  MIDI USB + BLE     │  Live-Recording
│
...
| **Tag Rescue** | Automatische Tag-Reparatur |
| **Track Cutter** | Songs zuschneiden |
| **Ringtone Setter** | Song als Klingelton setzen |
| **Waveform Editor** | Visueller Editor mit Lesezeichen |
| **BPM Analyzer** | FFT-basierte BPM- und Key-Erkennung |
| **Backup & Restore** | Vollständiges JSON-Backup |
| **Geräte-Transfer** | Song-Bibliothek per TCP übertragen |
...
| **Room Database** | 2.6.1 | Lokale Datenpersistenz (40 Tabellen) |
...
AutoPlayer was born out of a real need: a modern vehicle with a 10.1" Android Auto display, but no player on the market offering both a complete offline library and intelligent features with first-class Auto integration. What started as a personal project grew into an app with 113 features, 62 UI screens and 26 languages in ~8 weeks — developed with Claude AI as a development partner.
...
Full MediaBrowserService browse tree with 8 categories, individual album art per song,  
voice control in 26 languages, autoplay on connect, crash protection, tested in Dacia Jogger.

### 🧠 Smart Features

Smart DJ · Geo-Music · Nostalgia Machine · Mood Morph · Drive Mode DJ  
Sound Souvenir · Passenger Mode · Party Mode · Weather DJ · Heartbeat Sync  
Context Auto-Switch · Genome Visualizer · Sleep Fade · Shake to Shuffle  
Speed-based Volume · Music Wrapped (15 slides, 8 listener personalities)

### 🎹 Music Studio

Loop Mixer (8 tracks) · Pad Mode (16 pads) · Synth Studio (300+ presets)  
FM Synthesis DX7-style (200 presets) · Wavetable Synth (8 tables)  
Arpeggiator + Step Sequencer (16-step grid) · MIDI USB + BLE

### 🐾 Tamagotchi Mascot

5 pets (Cat, Dog, Bird, Fish, Dragon) · 62 achievements · 50 trick animations  
Reacts to music taste, listening duration, time of day · Level 1–1000 · Easter Egg: Trick Lab
...
| **Room Database** | 2.6.1 | Local persistence (40 tables) |
